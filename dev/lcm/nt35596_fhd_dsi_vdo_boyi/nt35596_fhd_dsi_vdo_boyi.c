...
{REGFLAG_DELAY, 40,  {}},//wait more than 120ms
...
static void lcm_init(void)
{
	...
	dsi_lcm_set_gpio_mode(GPIO5, GPIO_MODE_GPIO);
	dsi_lcm_set_gpio_dir(GPIO5, GPIO_DIR_OUT);
	dsi_lcm_set_gpio_out(GPIO5, GPIO_OUT_ONE);
...
static void lcm_suspend(void)
{
	...
	dsi_lcm_set_gpio_out(GPIO5, GPIO_OUT_ZERO);
