...
#define GPIO_LCD_BIAS_ENN (GPIO63 | 0x80000000)
#define GPIO_LCD_BIAS_ENP (GPIO64 | 0x80000000)
#define GPIO_LCD_ID_PIN         (GPIO81 | 0x80000000)
#define GPIO_LCD_BIAS_ENN_PIN	(GPIO63 | 0x80000000)
