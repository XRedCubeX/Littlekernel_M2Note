...
#else
	    params->dsi.PLL_CLOCK = 221; //208; //450; //this value must be in MTK suggested table
#endif
...
LCM_DRIVER hx8394d_hd720_dsi_vdo_ofilm_lcm_drv=
{
    .name           	= "hx8394d_hd720_dsi_vdo_ofilm",
